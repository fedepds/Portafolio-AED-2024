...
/**
 * Clase que representa un nodo de un árbol binario de búsqueda (ABB). Cada nodo
 * almacena una etiqueta
 * que lo identifica de manera única, los datos asociados a esa etiqueta, y las
...
public class TElementoAB<T> implements IElementoAB<T> {
    ...
    /**
     * Inserta un elemento en el subárbol cuya raíz es el nodo actual, respetando
     * las
     * propiedades del árbol binario de búsqueda.
     *
     * @param unElemento Elemento a insertar.
     * @return Verdadero si el elemento fue insertado, falso si ya existía un
     *         elemento con la misma etiqueta.
     */
    ...
    /**
     * Busca un elemento en el subárbol cuya raíz es el nodo actual, utilizando la
     * etiqueta como clave de búsqueda.
     *
    ...
    /**
     * Realiza un recorrido inorden del subárbol cuya raíz es el nodo actual y
    ...
    /**
     * Realiza un recorrido inorden del subárbol cuya raíz es el nodo actual y
     * agrega los datos de los
     * elementos a una lista pasada como parámetro.
     *
     * @param unaLista Lista donde se agregarán los datos de los elementos en
     *                 inorden.
     */
    ...
    /**
     * Elimina un elemento del subárbol cuya raíz es el nodo actual, utilizando la
     * etiqueta como clave de búsqueda.
     *
     * @param unaEtiqueta Etiqueta del elemento a eliminar.
     * @return El nodo que reemplaza al nodo eliminado en la posición que ocupaba
     *         dentro del árbol.
     */
    @Override
    @SuppressWarnings({ "unchecked" })
    ...
    /**
     * Auxiliar para el método eliminar. Realiza las operaciones necesarias para
     * quitar un nodo y mantener las
     * propiedades del árbol binario de búsqueda.
     *
    ...
    private TElementoAB<T> quitaElNodo() {
        ...
        // Se desconectan los hijos del nodo actual para facilitar el trabajo del
    ...
    /**
     * Retorna la cantidad total de nodos en el subárbol cuya raíz es el nodo
     * actual.
     *
    ...
    /**
     * Realiza un recorrido preorden del subárbol cuya raíz es el nodo actual y
     * agrega los datos de los
     * elementos a una lista pasada como parámetro.
     *
     * @param unaLista Lista donde se agregarán los datos de los elementos en
    ...
    /**
     * Realiza un recorrido postorden del subárbol cuya raíz es el nodo actual y
     * agrega los datos de los
     * elementos a una lista pasada como parámetro.
     *
     * @param unaLista Lista donde se agregarán los datos de los elementos en
    ...
    public double[] longTraInt(int nivel) {
        int lti = 0;
        int tam = 0;
        if (hijoIzq != null) {
            double[] resHijIzq = hijoIzq.longTraInt(nivel + 1);
            lti += resHijIzq[0];
            tam += resHijIzq[1];
        }
        if (hijoDer != null) {
            double[] resHijDer = hijoDer.longTraInt(nivel + 1);
            lti += resHijDer[0];
            tam += resHijDer[1];
        }
        double[] res = {lti + nivel, tam + 1};
        return res;
    }
