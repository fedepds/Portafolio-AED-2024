...
public class UtilGrafos {
    ...
    public static String imprimirMatrizMejoradoString(Double[][] matriz, Map<Comparable, TVertice> vertices, String cabecera) {
        ...
        for (Double[] fila : matriz) {
            sb.append(vertices.keySet().toArray()[indice] + "\t");
